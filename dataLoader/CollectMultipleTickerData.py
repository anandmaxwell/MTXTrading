...
class CollectMultipleTickerData:    
...
if __name__ == '__main__': 
    ...
    ticker ="SCODATUBES.NS , BHEL.NS" # 15-July chart is interesting
    #ticker ="BHEL.NS"
    period = "1d"
    interval = "2m"
    startdte ='2025-07-10'
    ...
    # Need to get only the  price
    #.................................................
    yahooFinanceDataCollector = CollectMultipleTickerData(ticker, period=period , interval = interval)
    tickerDFPrice = yahooFinanceDataCollector.collectDate()

    df = tickerDFPrice.loc[:, ('SCODATUBES.NS', )]
